...
- **Preuves** : `js/app.js` (export `reservations` ligne 6, `loadTransfers` lignes 8–40, `reserve` lignes 42–59, `cancelReservation` lignes 61–76, boucle rendant les boutons lignes 18–36), `index.html` (`<ul id="transfers-list">`, `<script src="js/app.js" type="module">`).
