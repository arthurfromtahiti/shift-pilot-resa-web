...
- **Preuves** : `js/app.js` (export `reservations` ligne 6, `pendingTransfers` ligne 8, `loadTransfers` lignes 10–42, `reserve` lignes 44–65, `cancelReservation` lignes 67–86, boucle rendant les boutons lignes 20–38), `index.html` (`<ul id="transfers-list">`, `<p id="transfers-error">`, `<script type="module" src="js/app.js">`).
